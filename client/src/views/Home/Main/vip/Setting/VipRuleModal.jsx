...
export function VipRuleModal({ status, ajax, closeModal }) {
  ...
  const cantSubmit =
    point !== baseRule && !Number.isNaN(point) && point > 0 && point <= 100
  ...
  return (
    ...
    >
      每1元消费累积&nbsp;&nbsp;
      <InputNumber min={1} max={100} value={point} onChange={handleChange} />
      &nbsp;&nbsp;积分
    </Modal>
  )
}
