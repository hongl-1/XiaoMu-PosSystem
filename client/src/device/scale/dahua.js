...
export class DahuaScale {
  ...
  convertDataToPlu(data) {
    ...
    return data.map(({ plu_code, code, name, unit_price }) => {
      ...
      return `!0V${plu_code}A${code}${convertToCent(
        unit_price
      )}000000000803000000000000000000000000000000000000000000000000B${nameZoneBitCode}C${nameZoneBitCode}D${nameZoneBitCode}E`
    })
