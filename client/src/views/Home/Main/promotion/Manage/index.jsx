...
export function Promotion() {
  ...
  const mapPromoList = useMemo(
    () =>
      promoList.map(({ start_date, end_date, ...args }) => ({
        ...args,
  ...
  const currentPromo = useMemo(
    () => promoList.find((i) => i.id === selectData.selectId),
    [selectData.selectId, promoList]
  )
  // 当前选中的活动
