...
function _ModifyDrawer({
  ...
  async function editCommodityFromPromo() {
    ...
    try {
      const { data } = await PromotionManage.editCommodityFromPromo(
        ajax,
        values
      )
  ...
  const children = [
    ...
    },
    {
      ...
      controlled: false,
      component: <Input value={currentCommodity.name} disabled />
    },
    {
      id: 'in_price',
      label: '商品进价',
      show: !!currentCommodity.name,
      controlled: false,
      component: <Input value={currentCommodity.in_price} disabled />
    },
    {
      id: 'sale_price',
      label: '商品售价',
      show: !!currentCommodity.name,
      controlled: false,
      component: <Input value={currentCommodity.sale_price} disabled />
    },
    {
      id: 'promotion_type',
      label: '促销类型',
  ...
  return (
    <Drawer visible={status} title={title} width={400} onClose={closeFn}>
      <Form {...formLayout}>
        {children
