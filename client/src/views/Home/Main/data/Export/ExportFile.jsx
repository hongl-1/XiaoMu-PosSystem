...
export function ExportFile({ status, startExport, dataType, reset }) {
  const config = [
    {
      status: 'ready',
      component: (
    ...
    },
    {
      ...
      component: (
        <Result
          ...
          title={`${dataType}导出失败!`}
          extra={[
            <Button onClick={startExport} key="restart" type="primary">
              重新导出
            </Button>
          ]}
        />
    ...
    },
    {
      ...
      component: (
        <Result
          ...
          title={`${dataType}导出成功!`}
          extra={[
            <Button onClick={reset} key="reset" type="primary">
              继续导出
            </Button>
          ]}
        />
  ...
  return <div className={styled['data-content-export']}>{component}</div>
}
